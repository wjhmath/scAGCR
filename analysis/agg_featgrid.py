...
b=dict((t,a) for t,n,a in rows).get('none')
print('!!! DEV ONLY — 任何赢家必须过全15确认关(>=+0.010 且 >=10/15)才算数 !!!')
print('%-14s%4s%8s%9s'%('config','n','ARI','dvs_none'))
for t,n,a in sorted(rows,key=lambda x:-x[2]):
    print('%-14s%4d%8.3f%+9.3f'%(t,n,a,(a-b) if b is not None else 0))
